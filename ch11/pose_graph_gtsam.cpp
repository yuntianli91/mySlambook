 ...
 * @LastEditTime: 2019-07-19 16:55:14
 */
...
int main(int argc, char** argv){
    ...
    vector<gtsam::Pose3> opt_variables;
    vector<int> opt_variable_ids;
    vector<gtsam::NonlinearFactor::shared_ptr> opt_factors;
    ...
    while(fin.peek()!= EOF){
        ...
        if (lineHead == "VERTEX_SE3:QUAT"){
            ...
            opt_variable_ids.push_back(id);
            opt_variables.push_back(gtsam::Pose3(R, t));
